...
export const CHAVE_MENSAGEM_AUTOMATICA = "CHAVE_MENSAGEM_AUTOMATICCA";
export const CHAVE_MENSAGEM_WHATSAPP = "CHAVE_MENSAGEM_WHATSAPP";
export const CHAVE_MENSAGEM_EMAIL = "CHAVE_MENSAGEM_EMAIL";
export const CHAVE_PIX = "CHAVE_PIX";
